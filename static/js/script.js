...
// :warning: Sirf LOCAL TESTING ke liye. Production LMS widget me yeh token yahan
...
  avatar.textContent = sender === 'bot' ? ':adult:\u200d:briefcase:' : 'A';
...
  row.id = 'cbTypingRow';
  row.innerHTML = `
    <div class="cb-mini-avatar">:adult:\u200d:briefcase:</div>
